...
import 'package:second_elementry_school/draganddropexercises/ex18.dart';
...
class Ex17 extends StatefulWidget {
  const Ex17({Key key}) : super(key: key);

  @override
  _Ex17State createState() => _Ex17State();
}

class _Ex17State extends State<Ex17> {
  ...
  String sucText1="قديم";
  String sucText2="نديم";
  String sucText3="جيران";
  String sucText4="نيران";

  String mainText1="...قــ";
  String mainText2="...نــ";
  String mainText3="...جيــ";
  String mainText4="...نيـــ";
            ...
            Positioned(
              ...
              child: Visibility(
                ...
                child: GestureDetector(
                  onTap: (){
                    Navigator.push(context, MaterialPageRoute(builder: (ctx)=>const Ex18()));
                  },
                  child: Row(
                    children: const[
