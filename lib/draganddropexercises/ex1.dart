...
import 'package:second_elementry_school/draganddropexercises/ex2.dart';
...
class _Ex1State extends State<Ex1> {
  ...
  String image2="assets/images/2.png";
  String image3="assets/images/3.png";
  String image4="assets/images/4.png";
                                 ...
                                 f4?Container(
                                   ...
                                   onAccept: (item)async{
                                     if((item as Map )["letter"]==value1){
                                       playWord("assets/sounds/words/nar.mp3",true);
                                       setState(() {
                                         f4=true;
                                       });
                                       setState(() {
                                ...
                                f3?Container(
                                  ...
                                  onAccept: (item){
                                    if((item as Map )["letter"]==value3){
                                      playWord("assets/sounds/words/maws.mp3",true);
                                      setState(() {
                                        f3=true;
                                      });
                                      setState(() {
                                ...
                                f2?Container(
                                  ...
                                  onAccept: (item){
                                    if((item as Map )["letter"]==value2){
                                      playWord("assets/sounds/words/waz.mp3",true);
                                      setState(() {
                                        f2=true;
                                      });
                                      setState(() {
                                ...
                                f1?Container(
                                  ...
                                  onAccept: (item){
                                    if((item as Map )["letter"]==value4){
                                     playWord("assets/sounds/words/dar.mp3",true).then((value) {
                                       setState(() {
                                         f1=true;
                                       });
                                     } );
            ...
            Positioned(
              ...
              child: Visibility(
                ...
                child: GestureDetector(
                  onTap: (){
                    Navigator.push(context, MaterialPageRoute(builder: (ctx)=>const Ex2()));
                  },
                  child: Row(
                   children: const[
