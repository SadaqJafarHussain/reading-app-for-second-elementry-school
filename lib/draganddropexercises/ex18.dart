...
class Ex18 extends StatefulWidget {
  const Ex18({Key key}) : super(key: key);

  @override
  _Ex18State createState() => _Ex18State();
}

class _Ex18State extends State<Ex18> {
  ...
  String sucText1="تُراب";
  String sucText2="غُراب";
  String sucText3="فَلاح";
  String sucText4="صَـلاح";

  String mainText1="...تُــ";
  String mainText2="...غَُــ";
  String mainText3="...فَــ";
  String mainText4="...صَــ";
