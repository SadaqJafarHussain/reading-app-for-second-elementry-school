...
import 'package:second_elementry_school/draganddropexercises/ex16.dart';
...
class Ex15 extends StatefulWidget {
  const Ex15({Key key}) : super(key: key);

  @override
  _Ex15State createState() => _Ex15State();
}

class _Ex15State extends State<Ex15> {
  ...
  String sucText1="شادي";
  String sucText2="زادي";
  String sucText3="دوري";
  String sucText4="نوري";
            ...
            Positioned(
              ...
              child: Visibility(
                ...
                child: GestureDetector(
                  onTap: (){
                    Navigator.push(context, MaterialPageRoute(builder: (ctx)=>const Ex16()));
                  },
                  child: Row(
                    children: const[
