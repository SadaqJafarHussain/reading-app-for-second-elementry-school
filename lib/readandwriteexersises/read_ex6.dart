...
import 'package:second_elementry_school/readandwriteexersises/read_ex7.dart';
import 'package:second_elementry_school/widgets/play_audio.dart';

import '../main.dart';

class ReadEx6 extends StatefulWidget {
  ReadEx6({Key key}) : super(key: key);

  @override
  State<ReadEx6> createState() => _ReadEx6State();
}

class _ReadEx6State extends State<ReadEx6> {
  final String image1="assets/images/55.png";

  final String image2="assets/images/34.png";

  final String text1="خُـبز";
  final String text2="خِـيار";
  final String text3="خَـروف";

  final String pref1="خُـ";
  final String pref2="خِـ";
  final String pref3="خَـ";
  bool correct1=false;
  bool correct2=false;
  bool correct3=false;
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      GestureDetector(
                        onTap: (){
                          Navigator.push(context, MaterialPageRoute(builder: (ctx)=>ReadEx7()));
                        },
