...
import 'package:second_elementry_school/readandwriteexersises/read_ex4.dart';
import 'package:second_elementry_school/widgets/play_audio.dart';

import '../main.dart';

class ReadEx3 extends StatefulWidget {
  ReadEx3({Key key}) : super(key: key);

  @override
  State<ReadEx3> createState() => _ReadEx3State();
}

class _ReadEx3State extends State<ReadEx3> {
  final String image1="assets/images/1.png";

  final String image2="assets/images/1.png";

  final String text1="نيـران";
  final String text2="نور";
  final String text3="نار";

  final String pref1="نيـ";
  final String pref2="نو";
  final String pref3="نا";
  bool correct1=false;
  bool correct2=false;
  bool correct3=false;
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      GestureDetector(
                        onTap: (){
                          Navigator.push(context, MaterialPageRoute(builder: (ctx)=>ReadEx4()));
                        },
