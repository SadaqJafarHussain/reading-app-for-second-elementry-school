...
class ReadEx8 extends StatefulWidget {
  ReadEx8({Key key}) : super(key: key);

  @override
  State<ReadEx8> createState() => _ReadEx8State();
}

class _ReadEx8State extends State<ReadEx8> {

  final String image1="assets/images/57.png";


  final String text1="ميـزان";
  final String text2="عِيـد";
  final String text3="فيـل";
  final String text4="مِـنشار";
  final String text5="عِـنب";
  final String text6="فِـراس";
  ...
  final String pref1="ميـ";
  final String pref2="عِيـ";
  final String pref3="فيـ";
  final String pref4="مِـ";
  final String pref5="عِـ";
  final String pref6="فِـ";
