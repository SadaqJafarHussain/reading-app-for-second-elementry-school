...
import 'package:second_elementry_school/readandwriteexersises/read_ex5.dart';
import 'package:second_elementry_school/widgets/play_audio.dart';

import '../main.dart';

class ReadEx4 extends StatefulWidget {
  ReadEx4({Key key}) : super(key: key);

  @override
  State<ReadEx4> createState() => _ReadEx4State();
}

class _ReadEx4State extends State<ReadEx4> {
  final String image1="assets/images/52.png";

  final String image2="assets/images/23.png";

  final String text1="عُـصفور";

  final String text2="عِـنب";

  final String text3="عَـلم";

  final String pref1="عُـ";

  final String pref2="عِـ";

  final String pref3="عَـ";
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      GestureDetector(
                        onTap: (){
                          Navigator.push(context, MaterialPageRoute(builder: (ctx)=>ReadEx5()));
                        },
