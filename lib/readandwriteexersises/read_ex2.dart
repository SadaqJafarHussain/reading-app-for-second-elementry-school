...
class ReadEx2 extends StatefulWidget {
  ReadEx2({Key key}) : super(key: key);

  @override
  State<ReadEx2> createState() => _ReadEx2State();
}

class _ReadEx2State extends State<ReadEx2> {
  final String image1="assets/images/4.png";

  final String image2="assets/images/4.png";

  final String text1="ديـنار";

  final String text2="دور";

  final String text3="دار";

  final String pref1="ديـ";

  final String pref2="دو";

  final String pref3="دا";
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      GestureDetector(
                        onTap: (){
                          Navigator.push(context, MaterialPageRoute(builder: (ctx)=>ReadEx3()));
                        },
